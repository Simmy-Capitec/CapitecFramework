...
-- Run this as: mysql -u root < clean-setup.sql
...
-- Create user for DBeaver access
DROP USER IF EXISTS 'sqltraining'@'localhost';
CREATE USER 'sqltraining'@'localhost' IDENTIFIED BY 'training123';
GRANT ALL PRIVILEGES ON sql_training.* TO 'sqltraining'@'localhost';
FLUSH PRIVILEGES;
...
('PHN003', 'Google Pixel 8', 'Google AI-powered phone', 699.99, 500.00, 7, 18, 7),
